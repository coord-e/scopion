...
public:
  ...
  template <class Op>
  value_t operator()(ast::single_op<Op> const& op)
  {
    return apply_op(op, boost::apply_visitor(*this, ast::val(op)[0]));
  }

  template <class Op>
  value_t operator()(ast::binary_op<Op> const& op)
  {
  ...
  template <class Op>
  value_t operator()(ast::ternary_op<Op> const& op)
  {
...
private:
  ...
  template <typename T>
  std::string createAndRegisterLazyName(lazy_value<T> v)
  {
  ...
  value_t apply_op(ast::binary_op<ast::add> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::sub> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::mul> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::div> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::rem> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::shl> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::shr> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::iand> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::ior> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::ixor> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::land> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::lor> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::eeq> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::neq> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::gt> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::lt> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::gtq> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::ltq> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::assign> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::call> const&,
                   value_t lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::at> const&,
                   value_t const lhs,
                   value_t const rhs);
  value_t apply_op(ast::binary_op<ast::dot> const&,
                   value_t const lhs,
                   value_t const rhs);
  ...
  value_t apply_op(ast::ternary_op<ast::cond> const&,
                   value_t const first,
